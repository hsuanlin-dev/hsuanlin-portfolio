        ...
        <div className="flex flex-col space-y-3">
          {WORK_EXPERIENCE.map((job) => (
            ...
            >
              ...
              <div className="relative w-full rounded-[15px] bg-white p-6 dark:bg-zinc-950">
                <div className="flex items-start gap-4">
                  {/* Company icon */}
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    {job.icon ? (
                      <img
                        src={job.icon}
